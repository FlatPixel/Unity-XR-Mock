...
namespace FlatPixel.XR.Mock
{
    ...
    {
        public static TrackableId Add(Pose pose, Pose leftEye, Pose rightEye, TrackingState trackingState = TrackingState.Tracking)
        {
            var id = NativeApi.UnityXRMock_createTrackableId(Guid.NewGuid());
            s_TrackingStates[id] = trackingState;
            NativeApi.UnityXRMock_setFaceData(id, pose, leftEye, rightEye, trackingState);
            return id;
        }

        public static void Update(TrackableId id, Pose pose, Pose leftEye, Pose rightEye)
        {
            NativeApi.UnityXRMock_setFaceData(id, pose, leftEye, rightEye, s_TrackingStates[id]);
        }
        ...
        static void SetFaceData(TrackableId id, Pose pose, Pose leftEye, Pose rightEye)
        {
            NativeApi.UnityXRMock_setFaceData(id, pose, leftEye, rightEye,
                s_TrackingStates[id]);
        }
