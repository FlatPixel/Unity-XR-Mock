...
namespace UnityEngine.XR.Mock
{
    ...
    /// </summary>
    public static class NativeApi_old
    {
        static NativeApi_old()
        {
        ...
        private readonly static Dictionary<TrackableId, anchorInfo> s_refPoints = new Dictionary<TrackableId, anchorInfo>();
        private readonly static Dictionary<TrackableId, anchorInfo> s_addedRefPoints = new Dictionary<TrackableId, anchorInfo>();
        private readonly static Dictionary<TrackableId, anchorInfo> s_updatedRefPoints = new Dictionary<TrackableId, anchorInfo>();
        private readonly static Dictionary<TrackableId, anchorInfo> s_removedRefPoints = new Dictionary<TrackableId, anchorInfo>();
        ...
        public static TrackableId UnityXRMock_attachAnchor(
            TrackableId trackableId, Pose pose)
        {
            ...
            if (!s_refPoints.ContainsKey(trackableId) || s_addedRefPoints.ContainsKey(trackableId))
            {
                ...
                {
                    s_refPoints[trackableId] = new anchorInfo()
                    {
                        id = trackableId
                    };
                }
        ...
        public static void UnityXRMock_updateAnchor(
        ...
        public static void UnityXRMock_removeAnchor(
        ...
        public static IDictionary<TrackableId, anchorInfo> anchors => s_refPoints;
        public static IReadOnlyCollection<anchorInfo> addAnchors => s_addedRefPoints.Values;
        public static IReadOnlyCollection<anchorInfo> updatedAnchors => s_updatedRefPoints.Values;
        public static IReadOnlyCollection<anchorInfo> removedAnchors => s_removedRefPoints.Values;

        #endregion

        public static void UnityXRMock_setRaycastHits(XRRaycastHit[] hits, int size)
        {
            LogNotImplemented();
        }
