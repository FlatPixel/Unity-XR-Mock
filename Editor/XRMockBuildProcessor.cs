...
namespace FlatPixel.XR.Mock
{
    ...
    /// </summary>
    public class XRMockBuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            XRMockSettings settings = null;
            EditorBuildSettings.TryGetConfigObject(XRMockLoaderConstants.k_SettingsKey, out settings);
            if (settings == null)
                return;
